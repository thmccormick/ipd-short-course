...
We will be providing datasets for the modules that use real data. For Option B, please download this [data](https://github.com/thmccormick/ipd-short-course/tree/main/content/data) folder into your local working directory (for Option A, these data will already be available in the docker image).

**Link to Data Folder**: [https://github.com/thmccormick/ipd-short-course/tree/main/content/data](https://github.com/thmccormick/ipd-short-course/tree/main/content/data)
